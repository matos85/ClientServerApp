...
# ____________________  вариант 1
...
# ____________________  вариант 2


list_str_format = [b'class', b'function', b'method']
...
for i in list_str_format:
    print('------------------------------------')
    print(f'Типы данных у слова: {i}: {type(i)},')
    print(f'Длина слова - {i}: {len(i)} символов')
    print(f'Содержимое слова: {i} ')
